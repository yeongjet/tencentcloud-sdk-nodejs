...
import { DescribeTaskResultResponse, DescribePeakBaseOverviewRequest, DisassociateAddressResponse, CreateNetworkInterfaceRequest, DescribeInstancesDeniedActionsRequest, ModifyModuleSecurityGroupsRequest, DescribeModuleResponse, DeleteSecurityGroupPoliciesRequest, ImportCustomImageResponse, ModifyModuleConfigResponse, ModifyModuleNameResponse, DescribeNetworkInterfacesRequest, DescribeSubnetsRequest, DescribeImportImageOsResponse, DeleteSubnetResponse, ModifyAddressesBandwidthResponse, DescribeSubnetsResponse, RunInstancesRequest, ReleaseAddressesRequest, DescribeInstancesResponse, ModifyModuleSecurityGroupsResponse, DescribeNodeResponse, RemovePrivateIpAddressesResponse, DescribeDefaultSubnetResponse, ReplaceSecurityGroupPolicyRequest, DescribeCustomImageTaskResponse, DeleteSubnetRequest, DescribeModuleRequest, CreateModuleResponse, RebootInstancesRequest, AllocateAddressesRequest, DeleteNetworkInterfaceRequest, RemovePrivateIpAddressesRequest, ModifyInstancesAttributeRequest, ResetInstancesResponse, DescribeImageRequest, MigratePrivateIpAddressRequest, ModifySubnetAttributeResponse, DescribeNodeRequest, CreateSubnetResponse, DescribeSecurityGroupPoliciesResponse, ModifyModuleConfigRequest, ModifySecurityGroupPoliciesRequest, DescribeConfigRequest, DescribeInstanceVncUrlRequest, StartInstancesResponse, CreateVpcResponse, DescribeTaskStatusResponse, ModifyModuleIpDirectRequest, CreateModuleRequest, ModifyInstancesAttributeResponse, ReleaseAddressesResponse, DescribeInstancesDeniedActionsResponse, DisassociateAddressRequest, ReplaceSecurityGroupPolicyResponse, StartInstancesRequest, CreateSubnetRequest, DescribeDefaultSubnetRequest, ResetInstancesMaxBandwidthResponse, DeleteSecurityGroupResponse, DeleteVpcRequest, CreateNetworkInterfaceResponse, RunInstancesResponse, DescribeAddressQuotaRequest, DescribeInstanceTypeConfigResponse, DescribeSecurityGroupLimitsResponse, DescribeAddressesResponse, DescribeSecurityGroupsResponse, ImportImageRequest, DetachNetworkInterfaceResponse, DeleteModuleRequest, CreateImageResponse, ModifyVpcAttributeRequest, ResetInstancesMaxBandwidthRequest, ResetInstancesPasswordResponse, ModifyModuleNetworkRequest, DetachNetworkInterfaceRequest, DescribeConfigResponse, ModifyModuleNetworkResponse, ModifyDefaultSubnetResponse, AssociateSecurityGroupsRequest, DescribeModuleDetailResponse, StopInstancesRequest, ModifyVpcAttributeResponse, DeleteVpcResponse, ModifySecurityGroupAttributeResponse, MigratePrivateIpAddressResponse, CreateImageRequest, DescribeInstanceVncUrlResponse, DeleteModuleResponse, DescribeInstanceTypeConfigRequest, ImportCustomImageRequest, DescribeModuleDetailRequest, AssociateAddressRequest, ModifySecurityGroupAttributeRequest, ModifySecurityGroupPoliciesResponse, DescribePeakNetworkOverviewResponse, AttachNetworkInterfaceResponse, DescribeVpcsRequest, DescribeBaseOverviewRequest, AssociateSecurityGroupsResponse, DescribeImportImageOsRequest, StopInstancesResponse, ModifyModuleIpDirectResponse, ModifyModuleNameRequest, ModifyDefaultSubnetRequest, DescribeInstancesRequest, DescribeTaskResultRequest, AssociateAddressResponse, TerminateInstancesResponse, DescribeAddressesRequest, DescribeSecurityGroupPoliciesRequest, MigrateNetworkInterfaceRequest, DescribeAddressQuotaResponse, CreateSecurityGroupPoliciesResponse, CreateSecurityGroupResponse, DescribeTaskStatusRequest, DeleteSecurityGroupRequest, ModifyAddressAttributeRequest, ModifyModuleImageResponse, ResetInstancesRequest, DescribeCustomImageTaskRequest, DescribeSecurityGroupAssociationStatisticsResponse, ModifyAddressAttributeResponse, ImportImageResponse, CreateSecurityGroupRequest, DescribeSecurityGroupLimitsRequest, TerminateInstancesRequest, DeleteNetworkInterfaceResponse, DescribePeakNetworkOverviewRequest, AssignPrivateIpAddressesResponse, DescribeSecurityGroupsRequest, RebootInstancesResponse, ModifyAddressesBandwidthRequest, DeleteSecurityGroupPoliciesResponse, DescribePeakBaseOverviewResponse, ModifyImageAttributeResponse, DescribeImageResponse, DeleteImageResponse, DescribeNetworkInterfacesResponse, AssignPrivateIpAddressesRequest, ResetInstancesPasswordRequest, ModifyImageAttributeRequest, CreateVpcRequest, DescribeSecurityGroupAssociationStatisticsRequest, DisassociateSecurityGroupsRequest, ModifySubnetAttributeRequest, AllocateAddressesResponse, AttachNetworkInterfaceRequest, ModifyModuleImageRequest, CreateSecurityGroupPoliciesRequest, MigrateNetworkInterfaceResponse, DescribeVpcsResponse, DeleteImageRequest, DescribeBaseOverviewResponse, DisassociateSecurityGroupsResponse } from "./ecm_models";
/**
 * ecm client
 * @class
 */
